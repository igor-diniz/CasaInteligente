...
('rua da areosa', 155, 4200083, 'Portugal'),
('rua da areosa', 130, 4200089, 'Portugal'),
('arquiteto lobão vital', 25, 4815549, 'Portugal'), 
('rua hill de moraes', 166, 60811760, 'Brasil'), 
('baker street', 122, 07730, 'Estados Unidos'),
('Avenida Abelardo Bueno', 2510, 22775040, 'Brasil');

--INSERT CASA
INSERT INTO Casa(endereco,numero, orientacaoSolar, qtdComodos) VALUES 
('rua da areosa',155, 'N', 3),
('rua da areosa',130, 'NE', 2),
('arquiteto lobão vital',25, 'L', 3),
...
--INSERT WifiAplicacao
INSERT INTO WifiAplicacao VALUES 
(1,1),
(2,1),
(3,3),
(4,6),
